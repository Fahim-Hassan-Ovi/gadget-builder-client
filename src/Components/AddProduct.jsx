...
const AddCoffee = () => {
    const handleAddProduct = event => {
        ...
        const newProduct = {product_title, price, rating, category, description, product_image};
        console.log(newProduct);

        // send data to the server
        fetch('https://gadget-builder-server.vercel.app/product', {
            method: 'POST',
            headers: {
    ...
    return (
        <div>
            <div>
                <h1 className='text-3xl font-bold text-[#374151]'>Add a Product</h1>
                <form onSubmit={handleAddProduct} className='flex justify-center mt-5'>
                    <fieldset className="fieldset bg-[#F4F3F0] border-base-300 rounded-box border p-4">
                        ...
                        <div className='md:flex mb-6'>
                            ...
                            <div className='md:w-1/2'>
                                ...
                                <input type="text" name='product_title' className="input" placeholder="Product Name" />
                            </div>

                            <div className='md:w-1/2'>
                                <label className="label mr-3">Photo URL</label>
                                <input type="text" name='product_image' className="input" placeholder="Photo URL" />
                            </div>
                        ...
                        <input type="submit" value="Add Product" className='btn btn-neutral bg-[#D2B48C] border-none shadow-none mt-4 text-white' />
                    </fieldset>
                </form>
            </div>
        </div>
